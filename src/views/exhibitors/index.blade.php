...
@section('content')
    <div class="container-fluid">
        <input type="hidden" name="visible"
            value="{{ auth()->user()->roles->first()->name == 'super-admin' ? true : false }}">
        <div class="row">
            <div class="col-12">
                <div class="card">
        ...
        $(document).ready(function() {
            $('table').DataTable({
                ...
                columns: [{
                    ...
                    //         return '<input name="is_admitted" type="checkbox" ' + (is_admitted ?
                    //                 'checked' : '') + ' data-toggle="toggle" data-on="' + yes +
                    //             '" data-style="ios" data-off="' + no +
                    //             '" data-onstyle="success" data-offstyle="danger" data-size="sm" ' +
                    //             (is_admitted ? 'disabled' : '') + '>';
                    //     },
