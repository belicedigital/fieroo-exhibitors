        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    @if ($exhibitor->created_at != $exhibitor->updated_at)
                        <div class="alert alert-info">
                            <strong>{{ trans('generals.last_updt') }}
                                {{ \Carbon\Carbon::parse($exhibitor->updated_at)->format('d/m/Y H:i:s') }}</strong>
                        </div>
                    @endif
                    <div class="alert alert-info">
                        <strong>{{ trans('entities.exhibitor') }}
                            {{ $exhibitor->locale == 'it' ? 'Italiano' : 'Inglese' }}</strong>
                    </div>
                    <form>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone_responsible" class="form-control w-100"
                                        value="{{ $exhibitor->phone_responsible }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="email_responsible">*
                                        {{ __('forms.exhibitor_form.exhibitor.company.responsible_email') }}</label>
                                    <input type="email" name="email_responsible" class="form-control w-100"
                                        value="{{ $exhibitor->email_responsible }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label
                                ...
                                @if ($exhibitor->locale == 'it')
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="uni_code" class="form-control w-100"
                                            value="{{ $exhibitor->uni_code }}" readonly>
                                    </div>
                                @endif
                                <div class="form-group">
                                    <label>{{ __('forms.exhibitor_form.diff_billing') }}</label>
                                    <select class="form-control" id="diff_billing" name="diff_billing" readonly disabled>
                                        <option value="no" {{ $exhibitor->diff_billing == 0 ? 'selected' : '' }}>
                                            {{ __('generals.no') }}</option>
                                        <option value="yes" {{ $exhibitor->diff_billing == 1 ? 'selected' : '' }}>
                                ...
                                <div class="form-group" data-billing>
                                    ...
                                    <input type="text" name="receiver" class="form-control w-100"
                                        value="{{ $exhibitor->receiver }}" readonly>
                                </div>
                                <div class="form-group" data-billing>
                                    <label
                                    ...
                                    <input type="text" name="receiver_address" class="form-control w-100"
                                        value="{{ $exhibitor->receiver_address }}" readonly>
                                </div>
                                <div class="form-group" data-billing>
                                    <label
                                    ...
                                    <input type="text" name="receiver_civic_number" class="form-control w-100"
                                        value="{{ $exhibitor->receiver_civic_number }}" readonly>
                                </div>
                                <div class="form-group" data-billing>
                                    <label for="receiver_city">{{ __('forms.exhibitor_form.data_billing.city') }}</label>
                                    <input type="text" name="receiver_city" class="form-control w-100"
                                        value="{{ $exhibitor->receiver_city }}" readonly>
                                </div>
                                <div class="form-group" data-billing>
                                    <label
                                    ...
                                    <input type="text" name="receiver_cap" class="form-control w-100"
                                        value="{{ $exhibitor->receiver_cap }}" readonly>
                                </div>
                                <div class="form-group" data-billing>
                                    <label
                                    ...
                                    <input type="text" name="receiver_province" class="form-control w-100"
                                        value="{{ $exhibitor->receiver_province }}" readonly>
                                </div>
                                <div class="form-group" data-billing>
                                    <label
                                    ...
                                    <input type="text" name="receiver_fiscal_code" class="form-control w-100"
                                        value="{{ $exhibitor->receiver_fiscal_code }}" readonly>
                                </div>
                                <div class="form-group" data-billing>
                                    <label
                                    ...
                                    <input type="text" name="receiver_vat_number" class="form-control w-100"
                                        value="{{ $exhibitor->receiver_vat_number }}" readonly>
                                </div>
                                @if ($exhibitor->locale == 'it')
                                    <div class="form-group" data-billing>
                                        <label
                                        ...
                                        <input type="text" name="receiver_uni_code" class="form-control w-100"
                                            value="{{ $exhibitor->receiver_uni_code }}" readonly>
                                    </div>
                                @endif
                                <div class="form-group">
                                    <h3>{{ __('forms.exhibitor_form.privacy_accepted_at', ['hour' => \Carbon\Carbon::parse($exhibitor->created_at)->format('H:i:s'), 'day' => \Carbon\Carbon::parse($exhibitor->created_at)->format('d/m/Y')]) }}
                                    </h3>
                                </div>
                                <div class="form-group">
                                    <label>{{ __('forms.exhibitor_form.terms_conditions.stats') }}</label>
